...
import 'package:watchlist/src/features/tv_series/presentation/providers/tv_series_detail_provider.dart';
import 'package:watchlist/src/features/tv_series/presentation/providers/watch_providers_provider.dart';
import 'package:watchlist/src/features/tv_series/presentation/providers/watchlist_provider.dart';
import 'package:watchlist/src/features/tv_series/presentation/views/season_detail_screen.dart';
import 'package:watchlist/src/features/tv_series/presentation/widgets/tv_series_dialog.dart';
...
class TVSeriesDetailScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final watchProvidersState =
        ref.watch(watchProvidersNotifierProvider(series.id));
            ...
            children: [
              ...
              watchProvidersState.when(
                ...
                error: (error, _) => const Center(
                    child: StyledText(text: 'Failed to load providers')),
              ),
              const SizedBox(height: 16),
              const StyledText(
                text: 'Seasons',
